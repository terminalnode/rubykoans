...
class AboutClassMethods < Neo::Koan
  ...
  class Dog
    # so class methods seem explicitly defined using the ClassName.method
  ...
  def test_you_can_use_self_instead_of_an_explicit_reference_to_dog
    # one would've assumed self would point to the object and not the class,
    # but apparently not. strange
  ...
  #
  # Top one for sure, it's more compact and more intuitive. Win-win.
  # Could perhaps consider using the bottom one to group multiple class
  # methods in a single block.
