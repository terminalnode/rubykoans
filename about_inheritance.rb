...
class AboutInheritance < Neo::Koan
  ...
  class BullDog < Dog
    def bark
      # that's cool. so super is refering to the output of the same
      # method in the super class. not the super class proper
      super + ", GROWL"
    end
  end
  ...
  class GreatDane < Dog
    def growl
      # and in fact can't refer to the super class proper? less cool
      super.bark + ", GROWL"
    end
  end
