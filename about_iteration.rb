...
class AboutIteration < Neo::Koan
  ...
  def test_collect_transforms_elements_of_an_array
    ...
    # more specifically, a better name
  ...
  def test_inject_will_blow_your_mind
    ...
    #
    # It's basically a fold/reduction of a list.
  end
  ...
  #
  # I would guess the first option works as a context manager in python,
  # or whatever it's called. basically it makes sure that the file is
  # closed, doesn't clutter the namespace or hog a bunch of RAM.
