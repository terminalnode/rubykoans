...
class AboutMessagePassing < Neo::Koan
  ...
  def test_send_with_underscores_will_also_send_messages
    ...
    # Simply because some classes may have their own send, but
    # we can always be sure that __send__ will do what we expect.
    #
    # Apparently send is an older function, and __send__ was added
    # after it was realised that people might want to use send
    # for other things.
  end
  ...
  def test_calling_method_missing_causes_the_no_method_error
    ...
    #
    # Ok, so the koan didn't really mention this it seems, but method_missing
    # is actually a built-in method. It's purpose is to give us a last chance
    # to fix things before an exception is thrown.
    #
    # It accepts three params, name of the method that we tried to call,
    # *args that we passed to the method and a &block that was passed to it.
    #
    # NOTE:
    #
  ...
  def test_catching_messages_makes_respond_to_lie
    ...
    # idk, doesn't seem like lying to me
