...
EOS
  ...
  def test_plus_equals_also_will_leave_the_original_string_unmodified
    ...
    # So, the strings are supposed to be mutable I think, but I
    # guess the concatenation operation returns a new string object
    # regardless
  end
  ...
  def test_the_shovel_operator_modifies_the_original_string
    ...
    #
    # Because it doesn't create a new object, and thus is more RAM efficient.
    # Probably.
  end
  ...
  def test_double_quoted_strings_interpolate_variables
    ...
    # f-strings by default! this is the life
  end
  ...
  def test_you_can_get_a_single_character_from_a_string
    ...
    # Surprised?
    # No. So basically strings work as arrays.
    # Neat-o
  end
